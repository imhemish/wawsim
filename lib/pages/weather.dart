          ...
          body: CustomScrollView(slivers: [
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: Obx(
                  () => DropdownMenu(enableSearch: false, textStyle: TextStyle(color: Colors.white),
                  dropdownMenuEntries: placesController.places.toList().map((e) => DropdownMenuEntry(value: e, label: e)).toList(),
                ...
                child: Obx(
                  () => Column(
                    ...
                    children: [
                      ...
                      Obx(() => SunDetails(weatherController.currentWeatherInformation.value.sunSet, weatherController.currentWeatherInformation.value.sunRise)),
                      SizedBox(
                        height: height / 20,
                      ),
